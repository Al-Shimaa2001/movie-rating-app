...
function handleSubmit() {
  emit('add-movie', { ...movieDetails.value })
...
<template>
  <main class="capitalize">
    ...
    <div class="flex gap-5 my-4">
      <Checkbox id="in-theater" v-model="movieDetails.inTheater" required />
    ...
    <DialogFooter class="sm:justify-between">
      ...
      <Button type="button" variant="default" @click="handleSubmit"> Add Movies </Button>
    </DialogFooter>
  </main>
</template>
